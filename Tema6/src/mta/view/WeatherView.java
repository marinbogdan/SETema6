...
public class WeatherView implements IView, IModel {
	...
	public void initialize() {
		...
		txtWeatherInformations.setFont(new Font("Rockwell Extra Bold",
				Font.PLAIN, 17));
		...
		textField_1_write.setFont(new Font("Rockwell Extra Bold", Font.PLAIN,
				17));
		...
		textField_2_write.setFont(new Font("Rockwell Extra Bold", Font.PLAIN,
				17));
